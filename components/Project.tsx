...
export default function Project({ title, description, tags, imageUrl, url }: ProjectProps){
    ...
    return (
        ...
        >
            <section ref={ref} className="bg-gray-100 max-w-[42ewm] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative 
            sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8:">
                    <a href={url} target="_blank">
                        ...
                        <Image 
                            ...
                            alt="foto"
                            quality={95}
                            //con la clase group hacemos las animaciones de los card con sus respectivas rotaciones
